    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-white/95 border-b border-gray-200 py-4 backdrop-blur-sm shadow-sm' : 'bg-transparent py-6'}`}>
      <div className="container mx-auto px-6 md:px-16 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link
            ...
            className={`text-sm font-medium transition-colors relative group ${isActive('/coordination-tax-calculator') ? 'text-brand-navy' : 'text-brand-slate hover:text-brand-navy'}`}
          >
            Calculator
      ...
      >
        <div className="bg-white border-t border-gray-100 shadow-lg px-6 py-6 flex flex-col gap-2">
          ...
          <Link
            to="/coordination-tax-calculator"
            className={`text-left text-base font-medium transition-colors py-2 border-b border-gray-50 ${isActive('/coordination-tax-calculator') ? 'text-brand-gold' : 'text-brand-slate hover:text-brand-navy'}`}
          >
            Calculator
          </Link>
          <Link
