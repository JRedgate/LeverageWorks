...
export class GeminiService {
  ...
  async getExecutionStrategy(prompt: string) {
    if (!this.ai) {
      return "The AI Strategist is currently offline. To enable this feature, configure your Gemini API key. In the meantime, LeverageWorks specializes in bridging the gap between AI capability and organizational execution for enterprise leaders across North America.";
    }
